      ...
      <div className = "main">
        <div> 
          ...
          <div className='section-1'>
            ...
            <div className='meetwithus'><a href =''>Meet with Us</a></div>
          ...
          <div className='section-3'>
            <h2>Solving big roblems takes time.</h2>
            <h2 className='yellow'>Are you ready for that journey?</h2>
            <ul>
              <li><h3>Are you uncertain about the root causes of your community's challenges?</h3></li>
          ...
          <div className='section-5'>
            <div className='mountainousbackground left'>
              ...
              <h3>We help changemakers and mission-driven organizations build resiliency at the organizational level to promote health equity within their own communities. You are creating health equity; we support you in establishing the practices and systems to keep your mission thriving and sustainable.</h3>
            </div>

            <div className='mountainousbackground right'>
                <div className='gethelp'>
                  <h1>Empower Yourself with Training</h1>
                  <ul>
          ...
          <div className='section-10'>
            ...
            <div className = 'infobox'>
              <ul>
                <li><a href = ''>Email: emailhere</a></li>
                <li><a href = ''>Book with this person</a></li>
                <li><a href = ''>Book with that person</a></li>
              </ul>
